...
//                .param("name","test1").param("age","10"))
    ...
    public void getPerson() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/getPerson/randytest")).andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.name").value("randytest"));
    }

    @Test
    public void listPerson() throws Exception {
        String responseString = mockMvc.perform(MockMvcRequestBuilders.get("/listPerson"))
    ...
    public void deletePerson() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get("/deletePerson/randytest")).andExpect(MockMvcResultMatchers.status().isOk());
    }
